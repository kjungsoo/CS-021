...
class VisualGame(object):
	def __init__(self):
		...
		self.bgCG = cg_script[5]
		self.charSpriteCG_01 = char_script[0]
		self.charSpriteCG_02 = char_script[1]
		self.charSpriteCG_03 = None
		self.charSpriteCG_04 = None
		self.charSpriteCG_05 = None
		...
		self.gameImage = PhotoImage(file = path.abspath(self.bgCG))
		...
		self.savefolder1_button = Button(self.saveFrame, text = "        Save 1", height = 100, width = 180, 
										 ...
										 padx = 10, pady = 10, relief = GROOVE, command = self.save("save1.txt"))
		...
		self.savefolder2_button = Button(self.saveFrame, text = "        Save 2", height = 100, width = 180, 
										 ...
										 padx = 10, pady = 10, relief = GROOVE, command = self.save("save2.txt"))
		...
		self.loadfolder1_button = Button(self.loadFrame, text = "        File 1", height = 100, width = 180, 
										 ...
										 padx = 10, pady = 10, relief = GROOVE, command = self.load("save1.txt"))
