...
class VisualGame(object): 
	def __init__(self):
		...
		self.loadfolder1_button = Button(self.loadFrame, text = "        File 1", height = 100, width = 180, 
										 ...
										 padx = 10, pady = 10, relief = GROOVE, command = self.load(open_file(path.abspath("saves\\save1.txt"))))
		...
		self.loadfolder2_button = Button(self.loadFrame, text = "        File 2", height = 100, width = 180, 
										 ...
										 padx = 10, pady = 10, relief = GROOVE, command = self.load(open_file(path.abspath("saves\\save2.txt"))))
